"""Explicit validation and configuration errors for AlphaForge.

All errors carry structured messages suitable for ACCP-YAML reports.
"""
...
class AlphaForgeError(Exception):
    """Base error for AlphaForge subsystem."""
