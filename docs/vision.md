...
* a **mode-scoped** system: `SWING`, `SCALP`, and `AGGRESSIVE_SCALP` use one shared training platform with separate scope-compatible artifacts, intervals, and label horizons
